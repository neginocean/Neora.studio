...
const i18n = {
  fa: {
    ...
    p1_desc: "طراحی لندینگ پیج کافه برند موناکافه",
    p2_desc: "سایت فروش فرش ایرانی برند فرش مانا ",
    p3_desc: "طراحی وبسایت فروش غذا های رژیمی برند باهوکلاب",
    p4_desc: "طراحی و پیاده سازی منو دیجیتال رستورانی. رستوران روف گاردن بیبر",
    p5_desc:
      "طراحی و پیاده سازی سایت فروش دستگاه های اتوماتیک شستشو کاتالیزور برند اتومک ترکیه",
    ...
    g1_title: "طراحی لیبل لاین vip محصولات عرقیجات رزنوش ",
    g1_desc:
    ...
    p3_pkg_price: "شروع از ۲۵,۰۰۰,۰۰۰ تومان",
